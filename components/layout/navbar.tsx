...
//         <div
//           className={`w-full flex flex-row items-center justify-between bg-white xl:px-24 lg:px-10 px-4 h-20`}
//         >
//           <Link href="/">
//             <Image
...
//             <ul
//               className={`
//                 ${scrolled ? "transition ease-in" : ""}
//                 hidden xl:flex xl:flex-row flex-grow  justify-between w-full h-full
//               `}
//             >
//               {navLinks.map((link, id) => (
//                 <nav className="grid  items-center mx-2 mb-4 xl:mb-0" key={id}>
//                   <Link
//                     href={link.url}
...
//               <div className="justify-end hidden w-[35%] xl:flex">
//                 <Link href="/contact">
//                   <button
//                     type="button"
...
//                   className="fixed top-0 right-0 bottom-0 bg-white z-50 lg:w-[40%] sm:w-3/4 w-11/12 flex flex-col py-8 sm:px-10 px-8 overflow-y-auto"
//                 >
//                   <span
//                     className="flex justify-end xl:hidden"
//                     onClick={() => setOpenMenu(false)}
//                   >
//                     {/* <img src={"/close.svg"} alt="close-icon" width={60} height={60} /> */}
//                     close
//                   </span>
...
//                   {navLinks.map((link, id) => (
//                     <nav className="grid items-center  mb-4" key={id}>
//                       <Link
//                         href={link.url}
//                         target={
//                           link.url.startsWith("http") ? "_blank" : "_self"
//                         }
//                         className={`transition-colors text-2xl font-rubik duration-200 hover:text-primary-100 ${
//                           pathname === link?.url
//                             ? "text-primary-100 font-bold"
...
//                   <div className="absolute w-1/2 bottom-10">
//                     <Link href="/contact">
//                       <button
//                         type="button"
//                         className="bg-primary-100 flex items-center justify-center gap-1.5 font-poppins w-[199px] h-[59px] text-white -tracking-[3%] font-bold"
//                       >
//                         CONTACT
//                       </button>
//                     </Link>
...
//             <div className="flex flex-row-reverse xl:hidden">
//               {!openMenu && (
