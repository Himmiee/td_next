...
export const AboutEndSection = () => {
  return (
    <main className="relative h-96 3xl:max-w-screen-3xl mx-auto px-4 flex flex-col items-center justify-center space-y-6 text-white bg-[#14002D]">
...
export const AboutFounderSection = () => {
  return (
    <main className="relative h-96 3xl:max-w-screen-3xl mx-auto px-4 flex flex-col items-center justify-center bg-white">
      {/* Randomly placed images with opacity */}
      <Image
        src={img}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full xl:px-24 items-center">
        {/* Title */}
        <div className="space-y-4 text-start xl:text-left">
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center xl:justify-end w-full">
