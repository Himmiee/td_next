      ...
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="relative flex items-center w-full sm:w-auto">
          <input
            ...
            className="w-full sm:w-[700px] h-14 py-2 px-4 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-100 focus:border-transparent"
          />
          <button
            type="submit"
